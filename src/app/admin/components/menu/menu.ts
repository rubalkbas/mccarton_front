...
export const menuItems = [ 
    ...
    new Menu (21, 'Materiales', '/admin/products/materials', null, 'category', null, false, 20), 
    ...
    new Menu (100, 'Preguntas Frecuentes', '/admin/followers', null, 'follow_the_signs', null, false, 0), 
