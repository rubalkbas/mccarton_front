...
import { ReseniasService } from 'src/app/_services/resenias.service';
import { Resenia } from 'src/app/models/resenia.model';
...
export class ReviewsComponent implements OnInit {
  ...
  listarResenias(){
    this.reseniasService.listarResenias().subscribe({
      next:response=>{
  ...
  public remove(review:any){  
    const dialogRef = this.dialog.open(ConfirmDialogComponent, {
      ...
      data: {
        ...
        message: "¿Está seguro de que desea eliminar esta reseña?"
      }
    }); 
