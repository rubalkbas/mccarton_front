...
`,
  styleUrls: ['./caja6.component.scss']
})
export class Caja6Component implements AfterViewInit {
  ...
  public ngAfterViewInit(): void {
    ...
    const camera = new THREE.PerspectiveCamera(18, threeCanvas.clientWidth / threeCanvas.clientHeight, 0.5, 1500);
    ...
    gltfloader.load('assets/images/caja/cajas/cajita.gltf', function (gltf) {
      model = gltf.scene;
      model.scale.set(0.20, 0.055, 0.13);
