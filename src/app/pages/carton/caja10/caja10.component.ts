...
`,
  styleUrls: ['./caja10.component.scss']
})
export class Caja10Component implements AfterViewInit {
  ...
  public ngAfterViewInit(): void {
    ...
    const camera = new THREE.PerspectiveCamera(35, threeCanvas.clientWidth / threeCanvas.clientHeight, 0.5, 1500);
    ...
    gltfloader.load('assets/images/caja/cajas/cajita.gltf', function (gltf) {
      model = gltf.scene;
      model.scale.set(0.27, 0.094, 0.24);
