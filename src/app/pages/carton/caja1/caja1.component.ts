...
`,
  styleUrls: ['./caja1.component.scss']
})
export class Caja1Component  implements AfterViewInit {
  ...
  public ngAfterViewInit(): void {
    ...
    const camera = new THREE.PerspectiveCamera(15, threeCanvas.clientWidth / threeCanvas.clientHeight, 0.5, 1500);
    ...
    gltfloader.load('assets/images/caja/cajas/cajita.gltf', function (gltf) {
      model = gltf.scene;
      model.scale.set(0.15, 0.05, 0.15);
