...
`,
  styleUrls: ['./caja2.component.scss']
})
export class Caja2Component implements AfterViewInit  {
  ...
  public ngAfterViewInit(): void {
    ...
    const camera = new THREE.PerspectiveCamera(23, threeCanvas.clientWidth / threeCanvas.clientHeight, 0.5, 1500);
